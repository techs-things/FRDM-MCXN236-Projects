...
- {id: CLK_144M_clock.outFreq, value: 144 MHz}
- {id: CLK_48M_clock.outFreq, value: 48 MHz}
- {id: EWM_clock.outFreq, value: 32.768 kHz}
- {id: FLEXCOMM0_clock.outFreq, value: 12 MHz}
- {id: FRO_12M_clock.outFreq, value: 12 MHz}
- {id: FRO_HF_clock.outFreq, value: 48 MHz}
- {id: LP_OSC_clock.outFreq, value: 32.768 kHz}
- {id: MAIN_clock.outFreq, value: 12 MHz}
- {id: PLL0_CLK_clock.outFreq, value: 150 MHz}
- {id: Slow_clock.outFreq, value: 3 MHz}
- {id: System_clock.outFreq, value: 12 MHz}
- {id: XTAL32K0_toVBAT_clock.outFreq, value: 32.768 kHz}
- {id: XTAL32K2_toWAKE_clock.outFreq, value: 32.768 kHz, locked: true, accuracy: '0.001'}
- {id: gdet_clock.outFreq, value: 48 MHz}
- {id: trng_clock.outFreq, value: 48 MHz}
settings:
...
- {id: OSCCLK_EN_VBAT, value: Enabled}
- {id: OSCCLK_EN_WAKE, value: Enabled}
- {id: RTC.RTCCLKSEL.sel, value: VBAT.XTAL32K0_toVBAT}
...
- {id: SCG.SCSSEL.sel, value: SCG.SIRC}
- {id: SCG.SIRCTRIMSRCSEL.sel, value: VBAT.XTAL32K2_toWAKE}
- {id: SCG.SIRC_TRIMDIV.scale, value: '1', locked: true}
...
- {id: SYSCON.FREQMEREFCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.FREQMETARGETCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: VBAT_OSCCTLA_OSC_EN, value: Enabled}
- {id: WDT1CLKDIV_HALT, value: Enable}
sources:
- {id: VBAT.OSC_32K.outFreq, value: 32.768 kHz, enabled: true}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
void BOARD_BootClockPLL150M(void)
{
    ...
    CLOCK_SetupFROHFClocking(48000000U);               /*!< Enable FRO HF(48MHz) output */
    SPC_SetLowPowerModeBandgapmodeConfig(SPC0, kSPC_BandgapEnabledBufferDisabled);      /* Bandgap enabled with Buffer disabled in Low Power mode. */
    SCG0->FIRCCSR |= SCG_FIRCCSR_FIRCSTEN_MASK;      /* Enables the FIRC clock source in Deep Sleep mode */
    SCG0->SIRCCSR |= SCG_SIRCCSR_SIRC_CLK_PERIPH_EN_MASK; 
    /*!< Set up PLL0 */
    ...
    CLOCK_SetupOsc32KClocking(kCLOCK_Osc32kToWake);      /* OSC_32 kHz output clock to Wake enabled */

    vbat_osc_config_t g_vbatOscConfig_BOARD_BootClockPLL150M = {
        .coarseAdjustment = kVBAT_OscCoarseAdjustment05,
        .enableInternalCapBank = false,
        .enableCrystalOscillatorBypass = false,
        .xtalCap = kVBAT_OscXtal0pFCap,
        .extalCap = kVBAT_OscExtal0pFCap,
    };
    VBAT_SetOscConfig(VBAT0, &g_vbatOscConfig_BOARD_BootClockPLL150M);

    CLOCK_SetRoscMonitorMode(kSCG_RoscMonitorDisable);    /* Monitor disabled */
