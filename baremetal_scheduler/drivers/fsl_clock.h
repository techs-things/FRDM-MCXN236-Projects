...
#define LP_FLEXCOMM_CLOCKS                                                                                  \
    {                                                                                                       \
        kCLOCK_LPFlexComm0, kCLOCK_LPFlexComm1, kCLOCK_LPFlexComm2, kCLOCK_LPFlexComm3, kCLOCK_LPFlexComm4, \
            kCLOCK_LPFlexComm5, kCLOCK_LPFlexComm6, kCLOCK_LPFlexComm7                                      \
    }
...
#define CM_UTICKCLKSEL    ((0x878 - 0x260) / 4)
...
typedef enum _clock_attach_id
{
    ...
    kCLK_1M_to_I3C0FCLK    = MUX_A(CM_I3C0FCLKSEL, 4),       /*!< Attach CLK_1M to I3C0FCLK. */
    ...
    kPLL0_to_I3C0FCLKSTC      = MUX_A(CM_I3C0FCLKSEL, 1),    /*!< Attach PLL0 to I3C0FCLKSTC. */
    kFRO_HF_to_I3C0FCLKSTC    = MUX_A(CM_I3C0FCLKSEL, 3),    /*!< Attach FRO_HF to I3C0FCLKSTC. */
    kCLK_1M_to_I3C0FCLKSTC    = MUX_A(CM_I3C0FCLKSEL, 4),    /*!< Attach CLK_1M to I3C0FCLKSTC. */
    kPLL1_CLK0_to_I3C0FCLKSTC = MUX_A(CM_I3C0FCLKSEL, 5),    /*!< Attach PLL1_clk0 to I3C0FCLKSTC. */
    kUSB_PLL_to_I3C0FCLKSTC   = MUX_A(CM_I3C0FCLKSEL, 6),    /*!< Attach USB PLL to I3C0FCLKSTC. */
    kNONE_to_I3C0FCLKSTC      = MUX_A(CM_I3C0FCLKSEL, 7),    /*!< Attach NONE to I3C0FCLKSTC. */

    kPLL0_to_I3C0FCLKSlow      = MUX_A(CM_I3C0FCLKSEL, 1),   /*!< Attach PLL0 to I3C0FCLKS. */
    kFRO_HF_to_I3C0FCLKSlow    = MUX_A(CM_I3C0FCLKSEL, 3),   /*!< Attach FRO_HF to I3C0FCLKS. */
    kCLK_1M_to_I3C0FCLKSlow    = MUX_A(CM_I3C0FCLKSEL, 4),   /*!< Attach CLK_1M to I3C0FCLKS. */
    kPLL1_CLK0_to_I3C0FCLKSlow = MUX_A(CM_I3C0FCLKSEL, 5),   /*!< Attach PLL1_clk0 to I3C0FCLKS. */
    kUSB_PLL_to_I3C0FCLKSlow   = MUX_A(CM_I3C0FCLKSEL, 6),   /*!< Attach USB PLL to I3C0FCLKS. */
    kNONE_to_I3C0FCLKSlow      = MUX_A(CM_I3C0FCLKSEL, 7),   /*!< Attach NONE to I3C0FCLKS. */
    ...
    kCLK_IN_to_UTICK   = MUX_A(CM_UTICKCLKSEL, 0),           /*!< Attach Clk_in to UTICK. */
    kXTAL32K2_to_UTICK = MUX_A(CM_UTICKCLKSEL, 1),           /*!< Attach xtal32k[2] to UTICK. */
    kCLK_1M_to_UTICK   = MUX_A(CM_UTICKCLKSEL, 2),           /*!< Attach clk_1m to UTICK. */
    kNONE_to_UTICK     = MUX_A(CM_UTICKCLKSEL, 3),           /*!< Attach NONE to UTICK. */
    ...
    kCLK_1M_to_I3C1FCLK    = MUX_A(CM_I3C1FCLKSEL, 4),       /*!< Attach CLK_1M to I3C1FCLK. */
    ...
    kPLL0_to_I3C1FCLKSTC      = MUX_A(CM_I3C1FCLKSEL, 1),    /*!< Attach PLL0 to I3C1FCLKSTC. */
    kFRO_HF_to_I3C1FCLKSTC    = MUX_A(CM_I3C1FCLKSEL, 3),    /*!< Attach FRO_HF to I3C1FCLKSTC. */
    kCLK_1M_to_I3C1FCLKSTC    = MUX_A(CM_I3C1FCLKSEL, 4),    /*!< Attach CLK_1M to I3C1FCLKSTC. */
    kPLL1_CLK0_to_I3C1FCLKSTC = MUX_A(CM_I3C1FCLKSEL, 5),    /*!< Attach PLL1_clk0 to I3C1FCLKSTC. */
    kUSB_PLL_to_I3C1FCLKSTC   = MUX_A(CM_I3C1FCLKSEL, 6),    /*!< Attach USB PLL to I3C1FCLKSTC. */
    kNONE_to_I3C1FCLKSTC      = MUX_A(CM_I3C1FCLKSEL, 7),    /*!< Attach NONE to I3C1FCLKSTC. */

    kPLL0_to_I3C1FCLKSlow      = MUX_A(CM_I3C1FCLKSEL, 1),   /*!< Attach PLL0 to I3C1FCLKS. */
    kFRO_HF_to_I3C1FCLKSlow    = MUX_A(CM_I3C1FCLKSEL, 3),   /*!< Attach FRO_HF to I3C1FCLKS. */
    kCLK_1M_to_I3C1FCLKSlow    = MUX_A(CM_I3C1FCLKSEL, 4),   /*!< Attach CLK_1M to I3C1FCLKS. */
    kPLL1_CLK0_to_I3C1FCLKSlow = MUX_A(CM_I3C1FCLKSEL, 5),   /*!< Attach PLL1_clk0 to I3C1FCLKS. */
...
typedef enum _clock_div_name
{
    ...
    kCLOCK_DivUtickClk    = ((0x3F0 - 0x300) / 4), /*!< Utick Clk Divider. */
    kCLOCK_DivFrg         = ((0x3F4 - 0x300) / 4), /*!< CLKOUT FRG Clk Divider. */
...
typedef enum _clock_ctrl_enable
{
    ...
    kCLOCK_CLKIN_ENA = SYSCON_CLOCK_CTRL_CLKIN_ENA_MASK, /*!< Enables clk_in clock for MICD, EMVSIM0/1, CAN0/1, I3C0/1,
                                                            SAI0/1, clkout */
    kCLOCK_FRO_HF_ENA =
